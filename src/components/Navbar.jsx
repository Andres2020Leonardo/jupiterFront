...
export default function Navbar() {
    return (
        ...
        <nav className="navbar navbar-expand-lg navbar-light shadow p-3  rounded" id="nav">
            <div className="col-sm-11 " id="container-navbar">
                ...
                <div className="" id="divBoton"><button type="button" className="btn btn-success" id="botonNavbar">
